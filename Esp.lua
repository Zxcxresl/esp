...
local success, errorMsg = pcall(function()
    ...
    print("Botón Volver de personalización creado")
    ...
    print("Botón Volver de fly creado")
    ...
    print("Evento de Botón Minimizar conectado")

    backButtonCustomize.MouseButton1Click:Connect(function()
        print("Botón Volver de personalización clickeado")
        customizeFrame.Visible = false
        frame.Visible = true
        flyFrame.Visible = false
    end)
    print("Evento de Botón Volver de personalización conectado")

    backButtonFly.MouseButton1Click:Connect(function()
        print("Botón Volver de fly clickeado")
        flyFrame.Visible = false
        frame.Visible = true
        customizeFrame.Visible = false
    end)
    print("Evento de Botón Volver de fly conectado")
